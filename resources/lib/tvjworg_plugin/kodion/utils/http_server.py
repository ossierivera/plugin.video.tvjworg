...
"""
    ...
    Copyright (C) 2018-2018 plugin.video.tvjworg
...
class YouTubeRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def __init__(self, request, client_address, server):
        self.addon_id = 'plugin.video.tvjworg'
    ...
    def do_GET(self):
        addon = xbmcaddon.Addon('plugin.video.tvjworg')
    ...
    def do_POST(self):
        ...
        if not self.connection_allowed():
            ...
            license_url = xbmcgui.Window(10000).getProperty('plugin.video.tvjworg-license_url')
            license_token = xbmcgui.Window(10000).getProperty('plugin.video.tvjworg-license_token')
